...
// const userApis = [
//   { name: "Get User by ID", endpoint: "/api/users/{id}", method: "GET" },
//   { name: "Get All Users", endpoint: "/api/users", method: "GET" },
//   { name: "Get Run by ID", endpoint: "/api/runs/{id}", method: "GET" },
//   { name: "Get All Runs", endpoint: "/api/runs", method: "GET" },
//   { name: "Get Profile", endpoint: "/api/users/profile", method: "GET" }, // Inherited from Guest
//   { name: "Get Runs for User", endpoint: "/api/runs/user/{id}", method: "GET" }, // Inherited from Guest
// ];
